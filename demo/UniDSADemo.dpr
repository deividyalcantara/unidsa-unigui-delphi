...
uses
  ...
  FrameQrCodeGenerator in 'View\FrameQrCodeGenerator.pas' {FrQrCodeGenerator: TUniFrame},
  FrameSignature in 'View\FrameSignature.pas' {FrSignature: TUniFrame},
  FrameBarcodeGenerator in 'View\FrameBarcodeGenerator.pas' {FrBarcodeGenerator: TUniFrame},
