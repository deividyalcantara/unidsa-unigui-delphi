...
procedure Navegar(comando: string; tipo: TUniDSABrowserMode = TUniDSABrowserMode.bmJQuery);

implementation

procedure Navegar(comando: string; tipo: TUniDSABrowserMode = TUniDSABrowserMode.bmJQuery);
var
  form: TFormUniDSABrowser;
begin
  form := TFormUniDSABrowser.Create(Application);
